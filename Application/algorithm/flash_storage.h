...
#define FLASH_STORAGE_FIRST_PAGE    62U
#define FLASH_STORAGE_PAGE_COUNT    2U
#define FLASH_STORAGE_ADDR          0x0801F000U
#define FLASH_STORAGE_PAGE_SIZE     2048U
#define FLASH_STORAGE_SIZE          (FLASH_STORAGE_PAGE_SIZE * FLASH_STORAGE_PAGE_COUNT)
#define FLASH_STORAGE_END_ADDR      (FLASH_STORAGE_ADDR + FLASH_STORAGE_SIZE)
